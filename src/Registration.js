    ...
    render() {
        return (
            <div>
                ...
                <input onChange={(e) => this.handleInputChange(e)} name="first" placeholder="first name" />

                <label htmlFor="last">last name: </label>
                <input onChange={(e) => this.handleInputChange(e)} name="last" placeholder="last name" />

                <label htmlFor="email">email address: </label>
                <input onChange={(e) => this.handleInputChange(e)} name="email" placeholder="email address" />

                <label htmlFor="password">password: </label>
                <input onChange={(e) => this.handleInputChange(e)} name="password" placeholder="password" />
